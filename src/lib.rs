...
#[derive(Debug)]
pub struct CNNImageNetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CNNImageNetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CNNImageNet processing");
    
    let mut processor = CNNImageNetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CNNImageNetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CNNImageNetProcessor::new(false);
